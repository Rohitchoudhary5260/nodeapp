...
const OrderModel = require("../schema/check")
...
router.patch("/editcheck/:id", async (req, res) => {
...
router.get("/allcheck", async (req, res) => {
...
router.delete("/deletecheck/:id", async (req, res) => {
